...
class BaseRoute {
	...
	public get(path: string, cbParam: any, arrayOfMiddlewares: any = false): void {
		if (arrayOfMiddlewares) {
			arrayOfMiddlewares.forEach(element => {
				this.router.get(path, element);
			});
		}
	...
	public post(path: string, cbParam: any, arrayOfMiddlewares: any = false): void {
		if (arrayOfMiddlewares) {
			arrayOfMiddlewares.forEach(element => {
				this.router.post(path, element);
			});
		}
		if (typeof cbParam === 'string') {
			let actionLoaded = LoaderUtil.loadAction(cbParam);
	...
	public put(path: string, cbParam: any, arrayOfMiddlewares: any = false): void {
		if (arrayOfMiddlewares) {
			arrayOfMiddlewares.forEach(element => {
				this.router.put(path, element);
			});
		}
		if (typeof cbParam === 'string') {
			let actionLoaded = LoaderUtil.loadAction(cbParam);
	...
	public patch(path: string, cbParam: any, arrayOfMiddlewares: any = false): void {
		if (arrayOfMiddlewares) {
			arrayOfMiddlewares.forEach(element => {
				this.router.patch(path, element);
			});
		}
		if (typeof cbParam === 'string') {
			let actionLoaded = LoaderUtil.loadAction(cbParam);
	...
	public delete(path: string, cbParam: any, arrayOfMiddlewares: any = false): void {
		if (arrayOfMiddlewares) {
			arrayOfMiddlewares.forEach(element => {
				this.router.delete(path, element);
			});
		}
		if (typeof cbParam === 'string') {
			let actionLoaded = LoaderUtil.loadAction(cbParam);
